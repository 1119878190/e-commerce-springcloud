...
/**
 * <h1>初始化 Hystrix 亲求上下文</h1>
 * 注意：由于我们项目引入了 zipkin + sleuth，会改变我们的并发策略改为SleuthHystrixConcurrencyStrategy，所以要将并发策略改为hystrix的
 */
@Slf4j
@Component
@WebFilter(
...
public class HystrixRequestContextServletFilter implements Filter {
    ...
    public void hystrixConcurrencyStrategyConfig() {
        try {
            ...
            log.info("config hystrix concurrent strategy success");
